...
python ../src/bens_masking.py --seqs "$1/silva-138-1-ssu-nr99-seqs-aligned.qza"
...
python ../src/process_rooted_tree.py --tree "$1/silva-138-1-ssu-nr99-seqs-rooted-tree-ben.qza"
