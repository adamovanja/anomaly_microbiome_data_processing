...
# requires having run get_silva_reads_n_classifier.sh before
...
python srcd/bens_masking.py --seqs "$1/silva-138.1-ssu-nr99-seqs-515f-806r-uniq-aligned.qza"
...
python srcd/process_rooted_tree.py --tree "$1/silva-138.1-ssu-nr99-seqs-515f-806r-uniq-rooted-tree-ben.qza"
